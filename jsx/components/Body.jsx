...
export default class Body extends React.Component{
	...
	render(){
		...
		return <main className="container"><LazyLoad once><BigPanel ltr="rtl" firstSrc="/img/assets/Shoot1-433-15.jpg" secondSrc="/img/assets/suite6-354-15.jpg" text={firstText}/></LazyLoad>
					 ...
					 <div className="main-container"><div className="row"><LittlePanel url="" img="/img/assets/offre1.jpg"/><LittlePanel url="" img="/img/assets/offre2.jpg"/><LittlePanel url="" img="/img/assets/offre3.jpg"/></div></div></main>;
