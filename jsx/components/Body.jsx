...
export default class Body extends React.Component{
	...
	render(){
		...
		var lpanel_thd_text = <div id="coffret" className="littlepanel-txt panel-inv"><h4>Coffrets Cadeaux</h4><ul><li>Séjour</li><li>Soins & Bien-Être</li><li>Gastronomie</li></ul><ul className="left-list"><li>Cabane d'exception</li><li>Chêque Cadeau</li></ul><p className="panel-price">48 EUR</p><div className="panel-features"><p className="panel-one-p">2 personnes</p></div></div>;
